...
public class AudioEncoder {
    ...
    private void prepare() {
        ...
        stopReceived = false;
        File tempsound = new File(Environment.getExternalStorageDirectory().getPath() +
        ...
        audioFormat.setInteger(MediaFormat.KEY_SAMPLE_RATE, 22050);
     ...
     */
    public void _stop(MediaCodec encoder) {
